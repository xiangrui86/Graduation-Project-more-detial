<template>
  <div class="review-management">
    ...
    <div class="page-header">
      ...
      <p class="page-subtitle">查看和管理平台所有商品的评价</p>
    </div>
...
<script>
import {
  getReviews as getAdminReviews,
  deleteReview as deleteAdminReview,
  deleteReviews as deleteAdminReviews,
} from "@/api/admin";
  ...
  methods: {
    ...
    deleteSelected() {
      this.$confirm(
        ...
        .then(async () => {
          try {
            const res = await deleteAdminReviews(this.selectedReviews);
            if (res.code === 200) {
